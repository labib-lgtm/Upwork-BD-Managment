      ...
      <header className="relative overflow-hidden border-b border-border">
        ...
        <div className="relative px-6 md:px-10 py-10 md:py-14">
          <div className="flex flex-col gap-4 max-w-3xl">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-primary/15 border w-fit border-black">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-foreground tracking-tight leading-tight">
              Lynx Media <span className="text-primary border-black">BD Tracker</span>
            </h1>
          ...
          {features.map((feature, idx) => {
            ...
            return (
              ...
              >
                ...
                <div className="relative inline-flex items-center gap-1.5 text-xs font-semibold text-black">
                  {feature.cta}
